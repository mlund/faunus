...
rosembluth:	src/examples/rosembluth/rb.cpp libfaunus
	$(CXX) $(CXXFLAGS) src/examples/rosembluth/rb.cpp -o src/examples/rosembluth/rosembluth $(LDFLAGS) 
examples:	rosembluth spce binding tools widom pka twobody twobody-hof manybody isobaric
clean:
	rm -f $(OBJS) *.o \
	...
	src/examples/rosembluth/rosembluth \
	src/libfaunus.a
docclean:
