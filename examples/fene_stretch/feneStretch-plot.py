...
mc = np.loadtxt('feneStretch-mc-rdf.dat', unpack=True, usecols=(0,1))
ld = np.loadtxt('feneStretch-md-rdf.dat', unpack=True, usecols=(0,1))
...
plt.savefig('feneStretch-plot.png')
plt.show()
