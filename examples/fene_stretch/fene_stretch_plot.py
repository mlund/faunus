...
mc = np.loadtxt('fene_stretch_mc_rdf.dat', unpack=True, usecols=(0,1))
ld = np.loadtxt('fene_stretch_md_rdf.dat', unpack=True, usecols=(0,1))
...
plt.savefig('fene_stretch_plot.png')
