...
mc = np.loadtxt('improper-dihedral-mc-rdf.dat', unpack=True, usecols=(0,1))
ld = np.loadtxt('improper-dihedral-md-rdf.dat', unpack=True, usecols=(0,1))
...
plt.savefig('improper-dihedral-plot.png')
