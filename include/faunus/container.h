...
namespace Faunus {
   ...
   * MUST be in sync.
   *
   * This class also takes care of particle insertion in the system, for
   ...
   * these to the "g" group pointer vector. The insertion method will
   * then automatically increase or decrease their sizes.
   *
   */
  class particles_PENDING {
    private:
      slump slp;
    public:
