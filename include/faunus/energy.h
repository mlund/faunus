...
protected:
    ...
    bool
    isTrial( const Tpvec &p ) const { return (&p == &spc->trial); }
...
public:
    ...
    virtual double
    p2p( const Tparticle &, const Tparticle & ) // Particle-particle energy
    { return 0; }

    virtual Point
    f_p2p( const Tparticle &, const Tparticle & ) // Particle-particle force
    { return Point(0, 0, 0); }

    virtual double
    all2p( const Tpvec &, const Tparticle & )  // Particle-Particle vector energy
    { return 0; }

    virtual double
    i2i( const Tpvec &, int, int )           // i'th particle with j'th particle
    { return 0; }

    virtual double
    i2g( const Tpvec &, Group &, int )       // i'th particle with group
    { return 0; }

    virtual double
    i2all( Tpvec &, int )              // i'th particle with all other particles
    { return 0; }

    virtual double
    i_external( const Tpvec &, int )         // internal energy of i'th particle
    { return 0; }

    virtual double
    i_internal( const Tpvec &, int )         // External energy of i'th particle
    { return 0; }

    virtual double
    p_external( const Tparticle & )   // External energy of particle
    { return 0; }

    /* @brief Total energy of i'th = i2all+i_external+i_internal */
    double
    i_total( Tpvec &p, int i ) { return i2all(p, i) + i_external(p, i) + i_internal(p, i); }

    /* @brief Group to group */
    virtual double
    g2g( const Tpvec &, Group &, Group & )     // Group-Group energy
    { return 0; }

    /* @brief Group in vector 1 with group in vector 2 */
    virtual double
    g1g2( const Tpvec &, Group &, const Tpvec &, Group & ) { return 0; }

    virtual double
    g_external( const Tpvec &, Group & )      // External energy of group
    { return 0; }

    virtual double
    g_internal( const Tpvec &, Group & )      // Internal energy of group
    { return 0; }

    virtual double
    v2v( const Tpvec &, const Tpvec & )       // Particle vector-Particle vector energy
    { return 0; }

    virtual double
    external( const Tpvec & )                // External energy - pressure, for example.
    { return 0; }

    virtual double
    update( bool= true )                     // Bool is acceptance/rejection of previous move
    { return 0; }

    /** @brief Update energy function due to Change */
    virtual double
    updateChange( const typename Tspace::Change &c ) { return 0; }

    virtual void
    field( const Tpvec &, Eigen::MatrixXd & ) //!< Calculate electric field on all particles
    {}
...
public:
    ...
    auto
    tuple() -> decltype(std::tuple_cat(first.tuple(), second.tuple()))
    {
    ...
    string
    info() override { return _info(); }

    void
    setSpace( typename T1::SpaceType &s ) override
    {
        first.setSpace(s);
        second.setSpace(s);
        Tbase::setSpace(s);
    ...
    double
    p2p( const Tparticle &a, const Tparticle &b ) override { return first.p2p(a, b) + second.p2p(a, b); }

    Point
    f_p2p( const Tparticle &a, const Tparticle &b ) override { return first.f_p2p(a, b) + second.f_p2p(a, b); }

    double
    all2p( const Tpvec &p, const Tparticle &a ) override { return first.all2p(p, a) + second.all2p(p, a); }

    double
    i2i( const Tpvec &p, int i, int j ) override { return first.i2i(p, i, j) + second.i2i(p, i, j); }

    double
    i2g( const Tpvec &p, Group &g, int i ) override { return first.i2g(p, g, i) + second.i2g(p, g, i); }

    double
    i2all( Tpvec &p, int i ) override { return first.i2all(p, i) + second.i2all(p, i); }

    double
    i_external( const Tpvec &p, int i ) override { return first.i_external(p, i) + second.i_external(p, i); }

    double
    i_internal( const Tpvec &p, int i ) override { return first.i_internal(p, i) + second.i_internal(p, i); }

    double
    g2g( const Tpvec &p, Group &g1, Group &g2 ) override { return first.g2g(p, g1, g2) + second.g2g(p, g1, g2); }

    double
    g1g2( const Tpvec &p1, Group &g1, const Tpvec &p2, Group &g2 ) override
    {
        return first.g1g2(p1, g1, p2, g2) + second.g1g2(p1, g1, p2, g2);
    }

    double
    g_external( const Tpvec &p, Group &g ) override { return first.g_external(p, g) + second.g_external(p, g); }

    double
    g_internal( const Tpvec &p, Group &g ) override { return first.g_internal(p, g) + second.g_internal(p, g); }

    double
    external( const Tpvec &p ) override { return first.external(p) + second.external(p); }

    double
    update( bool b ) override { return first.update(b) + second.update(b); }

    double
    updateChange( const typename Tspace::Change &c ) override { return first.updateChange(c) + second.updateChange(c); }

    double
    v2v( const Tpvec &p1, const Tpvec &p2 ) override { return first.v2v(p1, p2) + second.v2v(p1, p2); }

    void
    field( const Tpvec &p, Eigen::MatrixXd &E ) override
    {
        first.field(p, E);
        second.field(p, E);
    }
...
CombinedEnergy<T1, T2> &
operator+( const T1 &u1, const T2 &u2 ) { return *(new CombinedEnergy<T1, T2>(u1, u2)); }

template<class Tgeometry> struct FunctorScalarDist
{
    template<class Tparticle>
    inline double
    operator()( const Tgeometry &geo, const Tparticle &a, const Tparticle &b ) const
    {
...
public:
    ...
    auto
    tuple() -> decltype(std::make_tuple(this))
    {
        return std::make_tuple(this);
    }

    void
    setSpace( Tspace &s ) override
    {
        geo = s.geo;
        Tbase::setSpace(s);
        pairpot.setSpace(s);
    ...
    inline double
    p2p( const Tparticle &a, const Tparticle &b ) override
    {
    ...
    inline Point
    f_p2p( const Tparticle &a, const Tparticle &b ) override
    {
    ...
    double
    all2p( const Tpvec &p, const Tparticle &a ) override
    {
        double u = 0;
        for ( auto &b : p )
    ...
    double
    i2i( const Tpvec &p, int i, int j ) override
    {
        return pairpot(p[i], p[j], geo.sqdist(p[i], p[j]));
    }

    double
    i2g( const Tpvec &p, Group &g, int j ) override
    {
        double u = 0;
        if ( !g.empty())
        {
    ...
    double
    g2g( const Tpvec &p, Group &g1, Group &g2 ) override
    {
        double u = 0;
        if ( !g1.empty())
            if ( !g2.empty())
...
#pragma omp parallel for reduction (+:u)
    ...
    double
    g_internal( const Tpvec &p, Group &g ) override
    {
    ...
    double
    v2v( const Tpvec &p1, const Tpvec &p2 ) override
    {
        double u = 0;
        for ( auto &i : p1 )
            for ( auto &j : p2 )
...
public:
    ...
    double
    g2g( const typename base::Tpvec &p, Group &g1, Group &g2 ) override
    {
        double u = 0;
        for ( auto i : g1 )
            for ( auto j : g2 )
    ...
    double
    g_internal( const typename base::Tpvec &p, Group &g ) override
    {
        double u = 0;
        int b = g.back(), f = g.front();
        if ( !g.empty())
...
private:
    ...
    Point
    getMassCenter( const typename base::Tpvec &p, const Group &g )
    {
    ...
    bool
    cut( const Tpvec &p, const Group &g1, const Group &g2 )
    {
        return cut(p, g1, p, g2);
    }

    bool
    cut( const Tpvec &p1, const Group &g1, const Tpvec &p2, const Group &g2 )
    {
        if ( g1.isMolecular())
            if ( g2.isMolecular())
            {
...
public:
    ...
    double
    i2g( const Tpvec &p, Group &g, int i ) override
    {
    ...
    /**
           ...
           */
    double
    i2all( typename base::Tpvec &p, int i ) override
    {
    ...
    // unfinished
    void
    field( const typename base::Tpvec &p, Eigen::MatrixXd &E ) override
    {
        assert((int) p.size() == E.cols());
...
public:
    ...
    void
    add( const Faunus::Bonded::BondData &hb )
    {
    ...
    void
    add( const std::vector<Group *> &groups )
    {
        for ( auto g : groups )
    ...
    auto
    getBondList() -> decltype(this->list) { return Tbase::getBondList(); }
...
public:
    ...
    void
    add( double du ) { usum += du; }

    //!< Dumme rest treated as external potential to whole system
    double
    external( const typename Energybase<Tspace>::Tpvec &p ) override
    {
        return usum;
    }
};
...
public:
    ...
    /**
           ...
           */
    void
    setPressure( double pressure ) { P = pressure; }
    ...
    auto
    tuple() -> decltype(std::make_tuple(this)) { return std::make_tuple(this); }

    /** @brief External energy working on system. pV/kT-lnV */
    double
    external( const Tpvec &p ) override
    {
    ...
    double
    g_external( const Tpvec &p, Group &g ) override
    {
...
public:
    ...
    double
    p_external( const typename base::Tparticle &p ) override
    {
        return expot(p);
    }
    double
    i_external( const typename base::Tpvec &p, int i ) override
    {
        return p_external(p[i]);
    }
    double
    g_external( const typename base::Tpvec &p, Group &g ) override
    {
        double u = 0;
        for ( auto i : g )
            u += p_external(p[i]);
...
public:
    ...
    double
    g_external( const Tpvec &p, Group &g )
    {
        if ( &g != gPtr )
            return 0;
    ...
    double
    i_external( const Tpvec &p, int i )
    {
        auto gi = base::spc->findGroup(i);
...
public:
    ...
    double
    g_external( const typename Tspace::ParticleVector &p, Group &g1 ) override
    {
...
private:
    ...
    void
    loadSASA( const string &file, unsigned int n )
    {
        double s;
        std::vector<double> t;
        std::ifstream f(file);
    ...
    void
    save( const string &pfx = textio::prefix )
    {
        for ( auto &i : uofr )
        {
...
public:
    ...
    virtual Tvec
    operator()( Tspace &s, typename Tspace::ParticleVector &p )=0;

    size_t
    dim() const { return _min.size(); }   //!< dimension of coordinate
    const Tvec &
    min() const { return _min; }     //!< min value(s) for penalty coordinates
    const Tvec &
    max() const { return _max; }     //!< max value(s) for penalty coordinates
    unsigned int
    nstep() const { return _nstep; } //!< update frequency (steps)
    const Tvec &
    scale() const { return _scale; } //!< max value(s) for penalty coordinates

    /** @brief Determines if coordinate is within min:max */
    bool
    inrange( const Tvec &coord ) const
    {
...
public:
    ...
    Tvec
    operator()( Tspace &s, typename Tspace::ParticleVector &p ) override
    {
        Tvec r;
        for ( auto &i : c )
...
public:
...
#endif
    vector<Group *>
    PenalizedGroup( Tmjson &j, const string &sec, const string &mol )
    {
    ...
    void
    save( const string &filename, double s, const Tvec &limits )
    {
...
#endif
    double
    operator()( const typename base::Tpvec &p, bool trial )
    {
...
public:
    ...
    string
    info() override { return ptr->info(); }
    void
    test( UnitTest &t ) { ptr->test(t); }
    void
    load( const string &filename = "" ) { ptr->load(filename); }
    double
    currentPenalty() { return ptr->penalty[ptr->vpair.first]; }
    void
    saveRow( const string &filename = "", const Tvec &row = {0, 0, 0},
             double s = 1, const Tvec &limits = {0, 0, 0} )
    {
        ptr->saveRow(filename, row, s, limits);
    }
    void
    save( const string &filename = "", double s = 1, const Tvec &limits = {0} )
    {
        ptr->save(filename, s, limits);
    }
    double
    update( bool acceptance ) override
    {
...
public:
    ...
    Hamiltonian<Tspace> &
    push_back( const Tenergychild &pot )
    {
    ...
    double
    p2p( const Tparticle &p1, const Tparticle &p2 ) override
    {
        double u = 0;
        for ( auto b : baselist )
            u += b->p2p(p1, p2);
    ...
    Point
    f_p2p( const Tparticle &p1, const Tparticle &p2 ) override
    {
        Point p(0, 0, 0);
        for ( auto b : baselist )
            p += b->f_p2p(p1, p2);
    ...
    double
    i_external( const Tpvec &p, int i ) override
    {
        double u = 0;
        for ( auto b : baselist )
            u += b->i_external(p, i);
    ...
    double
    i_internal( const Tpvec &p, int i ) override
    {
        double u = 0;
        for ( auto b : baselist )
            u += b->i_internal(p, i);
    ...
    double
    v2v( const Tpvec &v1, const Tpvec &v2 ) override
    {
        double u = 0;
        for ( auto b : baselist )
            u += b->v2v(v1, v2);
...
double
systemEnergy( Tspace &spc, Tenergy &pot, const Tpvec &p )
{
...
double
energyChange( Tspace &s, Tenergy &pot, const typename Tspace::Change &c )
{
