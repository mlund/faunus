...
namespace Faunus {
  ...
  namespace Potential {
    ...
    class NemoRepulsion : public PairPotentialBase {
      ...
      public:
        NemoRepulsion(InputMap &in, const string &dir="") {
          name="Nemo repulsion";
          expmax = in("expmax", 80); // Maximum repulsion exponent
          scaling = 1000/(pc::Nav*pc::kT());  // Converts from kJ/mol to kT
          pairMap = json::atomPairMap("water2.json","pairproperties","nemorep");   // FIX!!!!!!!
        }
    ...
    class IonQuad : public PairPotentialBase {
      ...
      protected:
        double _lB;
      public:
        IonQuad(InputMap &in, const string &dir="") {
          name="Ion-Quad";
          in.cd ( jsondir+"/coulomb" );
          _lB = pc::lB( in("epsr",80. ) );
        }
    ...
    class IonIonQ : public Coulomb {
      ...
      public:
        IonIonQ(InputMap &in, const string &dir="") : Coulomb(in) { 
          name += " Q"; 
    ...
    class IonDipoleQ : public IonDipole {
      private:
        ...
        Tabulate::TabulatorBase<double>::data tabel;
      public:
        IonDipoleQ(InputMap &in, const string &dir="") : IonDipole(in) {
          name += " Q"; 
          _lB = Coulomb(in,dir).bjerrumLength();
          rc1  = in( "cutoff", pc::infty );
          rc1i = 1.0/rc1;
          ...
          qk.setRange(0,1);
          qk.setTolerance(in.get<double>("tab_utol",1e-5),in.get<double>("tab_ftol",1e-5)); // Tolerancekappa = 'Con'; in energy and force
          tabel = qk.generate( Qk );
        }
    ...
    class DipoleDipoleQ : public DipoleDipole {
      private:
        ...
        Tabulate::TabulatorBase<double>::data tabel;
      public:
        DipoleDipoleQ(InputMap &in, const string &dir="") : DipoleDipole(in) {
          name += " Q"; 
          _lB = Coulomb(in,dir).bjerrumLength();
          rc1  = in( "cutoff", pc::infty );
          rc1i = 1.0/rc1;
    ...
    class IonQuadQ : public IonQuad {
      private:
        ...
        Tabulate::TabulatorBase<double>::data tabel;
      public:
        IonQuadQ(InputMap &in, const string &dir="") : IonQuad(in) {
          name += " Q"; 
          _lB = Coulomb(in,dir).bjerrumLength();
          rc1  = in( "cutoff", pc::infty );
          rc1i = 1.0/rc1;
