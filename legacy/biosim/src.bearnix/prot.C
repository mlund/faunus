...
int main(int argc, char* argv[] ) {
  ...
  **********************************/
  ...
  double clust_dp = 10.;
  double save_max = par.getDbl("save_max",0.);
  double save_min = par.getDbl("save_min",0.);
  ...
  bool save_coord  = par.getBool("save_coord", false);
  ...
  h[3].name = "UvdW(r)";   h[3].type = histogram::AVERAGE;
  ...
  h[22].name = "U(ion-quad)";  h[22].type = histogram::AVERAGE;
  //h[8].name = "u(p1p2)";  h[8].type = histogram::AVERAGE;

  vector<histogram::data> hpoint(6);            //Distribution functions in 
  histogram hist2(0.05, 2.2);                   //one point   
  hist2.init(hpoint);
  hpoint[0].name = "P1.dip.z distribution"; hpoint[0].type = histogram::PROBABILITY;
  hpoint[1].name = "P2.dip.z distribution"; hpoint[1].type = histogram::PROBABILITY;
  hpoint[2].name = "Utot(n_z(1))";             hpoint[2].type = histogram::AVERAGE;
  hpoint[3].name = "Utot(n_z(2))";             hpoint[3].type = histogram::AVERAGE; 
  hpoint[4].name = "UvdW(n_z(1))";             hpoint[4].type = histogram::AVERAGE;
  hpoint[5].name = "UvdW(n_z(2))";             hpoint[5].type = histogram::AVERAGE; 
  ...
  cout << "# --- GROUPS ----------------------------------------\n";
  cout << g[P1] 
    << "#   Dipole        = " << s.p[g[P1].dipv] << endl
    << "#   Mass center   = " << s.p[g[P1].cm] << endl
    << g[P2]
    << "#   Dipole        = " << s.p[g[P2].dipv] << endl
  ...
  for (int macroCnt=1; macroCnt<=mc.macroSteps; macroCnt++) {
    for (int i=1; i<=mc.microSteps; i++) {
      ...
      if (slump.random_one()>0.5) {
        ...
        double q11=0,q12=0,q22=0,q13=0,q23=0,q33=0,uiq=0; //Temp quadropolar components
        int slask;
        for (slask=g[P1].beg; slask <= g[P1].end; slask++) {
          q11+=0.5*s.p[slask].charge*pow(s.p[slask].x - s.p[g[P1].cm].x,2);
          q22+=0.5*s.p[slask].charge*pow(s.p[slask].y - s.p[g[P1].cm].y,2);
          q33+=0.5*s.p[slask].charge*pow(s.p[slask].z - s.p[g[P1].cm].z,2);
        //  q12+=s.p[slask].charge*(s.p[slask].x - s.p[g[P1].cm].x)*(s.p[slask].y - s.p[g[P1].cm].y);
        //  q13+=s.p[slask].charge*(s.p[slask].x - s.p[g[P1].cm].x)*(s.p[slask].z - s.p[g[P1].cm].z);
        //  q23+=s.p[slask].charge*(s.p[slask].y - s.p[g[P1].cm].y)*(s.p[slask].z - s.p[g[P1].cm].z);
        }
        uiq=q2*(-q11*z*z-q22*z*z+q33*2*z*z)/pow(z,5);
        P1Trace+=q11+q22+q33;
        q11=0,q12=0,q22=0,q13=0,q23=0,q33=0;
        for (slask=g[P2].beg; slask <= g[P2].end; slask++) {
          q11+=0.5*s.p[slask].charge*pow(s.p[slask].x - s.p[g[P2].cm].x,2);
          q22+=0.5*s.p[slask].charge*pow(s.p[slask].y - s.p[g[P2].cm].y,2);
          q33+=0.5*s.p[slask].charge*pow(s.p[slask].z - s.p[g[P2].cm].z,2);
        //  q12+=s.p[slask].charge*(s.p[slask].x - s.p[g[P2].cm].x)*(s.p[slask].y - s.p[g[P2].cm].y);
        //  q13+=s.p[slask].charge*(s.p[slask].x - s.p[g[P2].cm].x)*(s.p[slask].z - s.p[g[P2].cm].z);
        //  q23+=s.p[slask].charge*(s.p[slask].y - s.p[g[P2].cm].y)*(s.p[slask].z - s.p[g[P2].cm].z);
        }
        uiq+=q1*(-q11*z*z-q22*z*z+q33*2*z*z)/pow(z,5);
        P2Trace+=q11+q22+q33;
        hist.add(h[22], z, pot.lB*uiq); //Don't forget the electrostatic units!
        ...
        hist.add(h[1], z, q1);
        hist.add(h[2], z, q2);
        hist.add(h[3], z, pot.energy_vdw(s.p, g[P1], g[P2]));
        ...
        //distributions in a singel point
        hist2.add(hpoint[0], (s.p[g[P1].dipv].z-s.p[g[P1].cm].z)+1.);
        hist2.add(hpoint[1], (s.p[g[P2].dipv].z-s.p[g[P2].cm].z)+1.); 
        hist2.add(hpoint[2], (s.p[g[P1].dipv].z-s.p[g[P1].cm].z)+1., utot);
        hist2.add(hpoint[3], (s.p[g[P2].dipv].z-s.p[g[P2].cm].z)+1., utot);
        hist2.add(hpoint[4], (s.p[g[P1].dipv].z-s.p[g[P1].cm].z)+1., pot.energy_vdw(s.p, g[P1], g[P2])); 
        hist2.add(hpoint[5], (s.p[g[P2].dipv].z-s.p[g[P2].cm].z)+1., pot.energy_vdw(s.p, g[P1], g[P2])); 
      };
      ...
      //Save configuration within a given interval
      if (z>=save_min && z<save_max && save_coord==true) {
        save_coord=false;
        cout << "#Configuration saved at z = " << z << endl;
        s.save( ".coord" +jobid );
        return 0;
      }
    ...
    cout << "# System energy (kT)       = " << usys << endl
      ...
      << "#   Quadrupole (Trace, Qxx+Qyy+Qzz: [A^-2]) = " << P1Trace.avg() <<endl 
      << "# Protein 2 (Q,C,mu)       = "
      << Q2.avg() << " " << Q2sq.avg()-pow(Q2.avg(),2) << " " << dip2.avg() << endl
      << "#   Quadrupole (Trace, Qxx+Qyy+Qzz: [A^-2]) = " << P2Trace.avg() <<endl 
  ...
  /**************************************
    ...
    **************************************/
  hist.show(h, minsep, maxsep);
  cout << "# Point distributions" <<endl;
  hist2.show(hpoint, 0, 2.2);
  mc.showStatistics();
