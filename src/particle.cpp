...
bool Dipole::isDipolar() const { return mulen > pc::epsilon_dbl; }
...
bool Polarizable::isPolarizable() const { return alpha.cwiseAbs().sum() > pc::epsilon_dbl; }
...
bool Quadrupole::isQuadrupolar() const { return Q.cwiseAbs().sum() > pc::epsilon_dbl; }
...
bool Cigar::isCylindrical() const { return half_length > pc::epsilon_dbl; }
